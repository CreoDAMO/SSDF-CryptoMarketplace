export const ESCROW_ADDRESS = process.env.NEXT_PUBLIC_ESCROW_ADDRESS || '0x7e1868430e86304Aac93a8964c4a1D5C12A76ED5';
export const NFT_ADDRESS = process.env.NEXT_PUBLIC_NFT_ADDRESS || '0x21Fb1fFaefA40c042276BB4Bcf8B826A647aE91E';
export const USDC_ADDRESS = process.env.NEXT_PUBLIC_USDC_ADDRESS || '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913';
export const TREASURY_ADDRESS = process.env.NEXT_PUBLIC_TREASURY_ADDRESS || '0x0000000000000000000000000000000000000000'; // Multi-sig treasury address
